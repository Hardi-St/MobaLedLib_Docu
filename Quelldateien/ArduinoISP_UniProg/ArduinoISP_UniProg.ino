// An den Tiny_UniProg angepasstes Programm von Hardi                                                         // 27.01.20:
// Äenderungen: suche nach TinyUniProg
...
void setup() {
  ...
  pinMode(9, OUTPUT); // TinyUniProg: Power pin
  digitalWrite(9, 1); // TinyUniProg:
}
...
void set_parameters() {
  ...
  rst_active_high = !(param.devicecode >= 0xe0);    // TinyUniProg:  Added !
}
